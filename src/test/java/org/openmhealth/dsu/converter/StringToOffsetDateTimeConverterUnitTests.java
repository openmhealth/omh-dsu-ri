...
public class StringToOffsetDateTimeConverterUnitTests {
    ...
    @Test
    public void convertShouldReturnCorrectTimestamp() throws Exception {

        OffsetDateTime result = converter.convert("2010-01-02T03:04:05.000000006+07:00");

        assertThat(result, equalTo(OffsetDateTime.of(2010, 1, 2, 3, 4, 5, 6, ZoneOffset.ofHours(7))));
    }
}